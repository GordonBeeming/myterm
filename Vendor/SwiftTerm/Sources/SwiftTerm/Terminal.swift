...
open class Terminal {
    ...
    public internal(set) var rows: Int = 25
     ...
     */
    public internal(set) var buffer: Buffer

    private let synchronizedOutputTimeoutSeconds: TimeInterval = 1.0
    public internal(set) var synchronizedOutputActive: Bool = false
    var synchronizedOutputTimeoutItem: DispatchWorkItem?
    var synchronizedOutputDeadlineUptimeNanoseconds: UInt64?
    ...
    public internal(set) var bracketedPasteMode: Bool = false
    ...
    public internal(set) var hostCurrentDirectory: String? = nil
    ...
    public internal(set) var hostCurrentDocument: String? = nil
    ...
    public internal(set) var mouseShiftCapture: Bool = false
